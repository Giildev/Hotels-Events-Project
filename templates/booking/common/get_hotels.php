...
$result_rate = $db->prepare("SELECT DISTINCT(ra.price), type FROM pm_rate as ra, pm_room as ro WHERE ro.id = id_room AND id_hotel = :hotel_id AND ra.price IN(SELECT MIN(ra.price) FROM pm_rate as ra, pm_room as ro WHERE ro.id = id_room AND id_hotel = :hotel_id)");
                ...
                <div class=\"isotopeContent\">
                    ...
                    <div class=\"row\">
                        <div class=\"col-xs-6\">
                            ...
                            <div class=\"text-muted\">".$texts['PRICE']." / ".$type."</div>
                        </div>
                        <div class=\"col-xs-6\">
