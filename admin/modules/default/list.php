...
// Inclusions
require_once(SYSBASE."admin/includes/fn_list.php");
...
<!DOCTYPE html>
<head>
    <?php include(SYSBASE."admin/includes/inc_header_list.php"); ?>
</head>
<body>
    <div id="wrapper">
                            ...
                            <div class="pull-left text-right">
                                ...
                                if(in_array("add", $permissions) || in_array("all", $permissions)){ ?>
                                    <a href="index.php?view=form&id=0">
                                        <button class="btn btn-primary mt15" type="button"><i class="fa fa-plus-circle"></i> <?php echo $texts['NEW']; ?></button>
                                    </a>
                                    <?php
                                } ?>
                            </div>
                        ...
                        <div class="panel-heading form-inline clearfix">
                            <div class="row">
                                <div class="col-md-6 text-left">
                                    ...
                                    <button class="btn btn-default" type="submit" id="search" name="search"><i class="fa fa-search"></i> <?php echo $texts['SEARCH']; ?></button>
                                </div>
                                        ...
                                        foreach($result as $i => $row){
                                            ...
                                            <tr id="item_<?php echo $id ?>">
                                                ...
                                                if(NB_FILES > 0){
                                                    ...
                                                    if($result_img !== false && $db->last_row_count() == 1){
